...
releases: "0.23.0": {
	...
	description: """
		...
		* Write description
		* Write whats_next
		* Write highlight for secrets loading
		* Remaining issues in https://github.com/vectordotdev/vector/milestone/87
		* Move highlight for kube list/watch to 0.23
		* Note removal of support for old OSs, to be readded(?)
		* More verbose examples for type definition changes
		"""
	...
	changelog: [
		{
			...
			scopes: ["sinks", "codecs"]
			description: """
				TODO document sink encoding options
				"""
			pr_numbers: []
		},
		{
		...
		},
		{
			...
			description: """
				...
				the [release highlight](TODO) for more details.
				"""
			pr_numbers: [11985]
		},
		{
		...
		},
		{
			...
			description: """
				...
				>= 0.11.0 of the helm chart or adding the `list` and `watch` verbs to the allowed actions for the Vector
				pod. See the [upgrade
				guide](/highlights/2022-05-23-0-23-0-upgrade-guide#kubernetes-logs-list-watch-nodes) for more
				details.
				"""
			contributors: ["nabokihms"]
			breaking: true
		...
		},
		{
			...
			description: """
				...
				See the [upgrade guide](/en/highlights/2022-05-23-0-23-0-upgrade-guide.md) for more details.
				"""
		...
		},
		{
			...
			description: """
				...
				See the [upgrade guide](highlights/2022-05-23-0-23-0-upgrade-guide#vrl-parse_grok) for details.
				"""
			breaking: true
			pr_numbers: [13008]
		},
